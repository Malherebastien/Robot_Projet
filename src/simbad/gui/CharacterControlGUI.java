 ...
 */
public class CharacterControlGUI extends JPanel implements ActionListener
{
    ...
    public CharacterControlGUI(World world, Simulator simulator) {
        this.world = world;
        smallFont = new Font("Arial",Font.PLAIN,11);
        createGUI();
        currentAgent = (Character) simulator.getAgentList().get(0);
